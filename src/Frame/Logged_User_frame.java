...
//	private String pozicija;
	...
	public Logged_User_frame(final String username, String position) throws IOException, ParseException {
		frame = new JFrame();
		...
		if(position.equals("m")) {
			...
			JMenuItem kozmeticMonthlyProfitItem = new JMenuItem("Tabela prihoda kozmeticara");
			JMenuItem loyalClientsViewItem = new JMenuItem("Tabela lojalnih klijenata");
			JMenuItem kozmeticTreatmentsViewItem = new JMenuItem("Tabela kozmetickih tretmana");
			JMenuItem detailedtreatmentViewItem = new JMenuItem("Tabela pregleda usluge");
			//JMenuItem grafovi_Item = new JMenuItem("Prikaz grafova");			
			prikazPrihodaRashodaMenu.add(kozmeticMonthlyProfitItem);
			prikazPrihodaRashodaMenu.add(loyalClientsViewItem);
			prikazPrihodaRashodaMenu.add(kozmeticTreatmentsViewItem);
			prikazPrihodaRashodaMenu.add(detailedtreatmentViewItem);
			...
			kozmeticMonthlyProfitItem.addActionListener(new ActionListener() {
		           public void actionPerformed(ActionEvent e) {		        	   
		        	   managerService.KozmeticMonthlyView();
		           }
		    	});
			loyalClientsViewItem.addActionListener(new ActionListener() {
		           public void actionPerformed(ActionEvent e) {		        	   
		        	   managerService.LoyalClientsView();
		           }
		    	});
			kozmeticTreatmentsViewItem.addActionListener(new ActionListener() {
		           public void actionPerformed(ActionEvent e) {		        	   
		        	   try {
						managerService.kozmeticTreatmentsView();
					} catch (IOException e1) {
						e1.printStackTrace();
					}
		           }
		    	});	
			detailedtreatmentViewItem.addActionListener(new ActionListener() {
		           public void actionPerformed(ActionEvent e) {		        	   
		        	   managerService.detailedtreatmentView();
		           }
		    	});
...
//		    	});
			...
			final RecepcionistService recepcionistService = new RecepcionistService(username);
